	...
	return (function e(t, n, r) {
	...
	})(
		{
			...
			2: [
				...
				{ 'sentence-case': 24, 'upper-case': 28 },
			],
			3: [
				function(_dereq_, module, exports) {
					'use strict';
			...
			6: [
				function(_dereq_, module, exports) {
					...
					exports.other = new Type('Other', {
						pattern: /^1\d{12}(\d{3}|\d{6})?$/,
						eagerPattern: /^(1|2[6-9]|5[6-9]|7|8|9)/,
					});
			...
			7: [
				...
				{ './src/card': 8, './src/cvc': 9, './src/expiration': 10 },
			],
			8: [
				function(_dereq_, module, exports) {
					'use strict';
			...
			10: [
				...
				{ 'is-valid-month': 18, 'parse-int': 22, 'parse-year': 23 },
			],
			11: [
				function(_dereq_, module, exports) {
					'use strict';
				...
				{ 'camel-case': 2, 'creditcards-types': 4, xtend: 29 },
			],
			12: [
				function(_dereq_, module, exports) {
					'use strict';
			...
			24: [
				...
				{
					'./vendor/camel-case-regexp': 25,
					'./vendor/non-word-regexp': 26,
					'./vendor/trailing-digit-regexp': 27,
					'lower-case': 20,
				},
			],
			25: [
			...
			32: [
								...
								return function(scope, element, attributes, ngModel) {
									ngModel.$validators.ccCvc = function(value) {
										return (
											...
											cvc.isValid(value, $parse(attributes.ccType)(scope))
										);
									};
				...
				{ creditcards: 7, 'function-bind': 15 },
			],
			33: [
				function(_dereq_, module, exports) {
					'use strict';
					...
					function CcExpController($scope, $element) {
						...
						function setValidity(exp) {
							...
							var valid =
								...
								(!!expMonth && !!expYear && !expiration.isPast(expMonth, expYear));
							...
							compile: function(element, attributes) {
								...
								return function(scope, element, attributes, controllers) {
									...
									ngModel.$validators.ccExpYear = function validateExpYear(value) {
										return (
											ngModel.$isEmpty(ngModel.$viewValue) ||
											(year.isValid(value) && !year.isPast(value))
										);
									};
								};
							},
			...
			34: [
				...
				{ ap: 1, 'cast-array': 3, creditcards: 7 },
			],
			35: [
				function(_dereq_, module, exports) {
					(function(global) {
