...

{
		...
		smaug: {
			in: {
				...
				trigger: {
					...
					color: [{ value: '#6fbb95', duration: 1, delay: 130, easing: 'easeOutQuad' }],
				},
			},
			out: {
				base: {
				...
				trigger: {
					...
					color: [{ value: '#666', duration: 1, delay: 200, easing: 'easeOutQuad' }],
				},
			},
		},
		uldor: {
		...
		walda: {
			in: {
				...
				content:
					...
					_defineProperty(_content, 'easing', 'linear'),
					_defineProperty(_content, 'translateY', ['50%', '0%']),
					_defineProperty(_content, 'opacity', [0, 1]),
					_content),
				trigger: {
					translateX: [
					...
					color: [{ value: '#6fbb95', duration: 1, delay: 100, easing: 'easeOutQuad' }],
				},
			},
			out: {
				base: {
				...
				trigger: {
					...
					color: [{ value: '#666', duration: 1, delay: 100, easing: 'easeOutQuad' }],
				},
			},
		},
		gram: {
		...
		narvi: {
			in: {
				...
				trigger: {
					...
					color: [{ value: '#6fbb95', duration: 1, delay: 100, easing: 'easeOutQuint' }],
				},
			},
			out: {
				base: {
				...
				trigger: {
					...
					color: [{ value: '#666', duration: 1, delay: 200, easing: 'easeOutQuint' }],
				},
			},
		},
		indis: {
		...
		amras: {
			in: {
				...
				path:
					...
					_defineProperty(_path, 'delay', function delay(t, i) {
						return i * 20;
					}),
					_defineProperty(_path, 'scale', [0, 1]),
					_path),
				content: {
					duration: 300,
					delay: 250,
		...
		hador: {
			in: {
				...
				trigger: {
					...
					color: [{ value: '#6fbb95', duration: 1, delay: 200, easing: 'easeOutExpo' }],
				},
			},
			out: {
				base: {
	...
	var Tooltip = (function() {
		function Tooltip(el) {
			...
			this.DOM.trigger = this.DOM.el.querySelector('.s-tooltip__trigger');
			this.DOM.triggerSpan = this.DOM.el.querySelector('.s-tooltip__trigger-text');
			this.DOM.base = this.DOM.el.querySelector('.s-tooltip__base');
			this.DOM.shape = this.DOM.base.querySelector('.s-tooltip__shape');
			if (this.DOM.shape) {
				this.DOM.path =
			...
			this.DOM.deco = this.DOM.base.querySelector('.s-tooltip__deco');
			this.DOM.content = this.DOM.base.querySelector('.s-tooltip__content');

			this.DOM.letters = this.DOM.content.querySelector('.s-tooltip__letters');
			if (this.DOM.letters) {
			...
			},
			{
				...
				value: function animate(dir) {
					...
					if (config[this.type][dir].trigger) {
						...
						var triggerAnimOpts = { targets: this.DOM.triggerSpan };
